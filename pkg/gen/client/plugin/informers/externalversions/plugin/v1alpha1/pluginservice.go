...
type PluginServiceInformer interface {
	...
	Lister() v1alpha1.PluginServiceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PluginV1alpha1().PluginServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PluginV1alpha1().PluginServices(namespace).Watch(context.TODO(), options)
			},
		},
		&pluginv1alpha1.PluginService{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pluginServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pluginv1alpha1.PluginService{}, f.defaultInformer)
}

func (f *pluginServiceInformer) Lister() v1alpha1.PluginServiceLister {
	return v1alpha1.NewPluginServiceLister(f.Informer().GetIndexer())
}
