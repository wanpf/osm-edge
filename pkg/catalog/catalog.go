...
func NewMeshCatalog(kubeController k8s.Controller, meshSpec smi.MeshSpec, certManager *certificate.Manager,
	policyController policy.Controller, pluginController plugin.Controller, multiclusterController multicluster.Controller,
	stop <-chan struct{}, cfg configurator.Configurator, serviceProviders []service.Provider,
	endpointsProviders []endpoint.Provider, msgBroker *messaging.Broker) *MeshCatalog {
	mc := &MeshCatalog{
